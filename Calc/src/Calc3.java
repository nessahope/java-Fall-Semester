	...
	public static void main(String[] args) {
		...
		do {
			...
			case 1 : {
				...
				i++;
				System.out.println(c1.Add(arr_Two[i][0], arr_Two[i][1]));
			}break;
			case 2: {
				System.out.println("Enter the first value: ");
				arr_Two[i][0] = inputValue.nextDouble();
				...
				arr_Two[i][1] = inputValue.nextDouble();
				i++;
				System.out.println(c1.Subtract(arr_Two[i][0], arr_Two[i][1]));
			}break;
			case 3: {
				System.out.println("Enter the first value: ");
				arr_Two[i][0] = inputValue.nextDouble();
				...
				arr_Two[i][1] = inputValue.nextDouble();
				i++;
				System.out.println(c1.Divide(arr_Two[i][0], arr_Two[i][1]));
			...
			case 4: {
				...
				arr_Two[i][1] = inputValue.nextDouble();
				i++;
					System.out.println(c1.Multiply(arr_Two[i][0], arr_Two[i][1]));
			}break;
			case 0 : {
				int op = 0;
